...
define([
    ...
    return Component.extend({
        ...
        getCustomChangeOption: function(){
            var selectOption = document.getElementById('customOption').value;
            alert("Select Value: " + selectOption);
